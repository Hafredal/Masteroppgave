...
\noindent
Det ble tidlig avdekket tydelige ulikheter i sykepleiernes anvendelse av pasientsignalsystemet. Motivasjonen for forskningsarbeidet ble dermed å kartlegge disse og å identifisere årsaker til hvorfor de har oppstått, med en sosioteknisk tilnærming. En slik tilnærming til IKT-systemer forsøker å forstå hvordan mellommenneskelige aspekter og tekniske systemer påvirker hverandre.
Et slikt system benyttes av mange brukere i ulike kontekster med ulike behov. Det er derfor blitt gjort lokale tilpasninger av systemet som skiller seg fra tenkt bruk. 
