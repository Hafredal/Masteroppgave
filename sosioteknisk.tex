...
I dag er imidlertid teknologien i stor grad integrert i det sosiale domenet, noe det må tas hensyn til ved design av tekniske systemer. Mennesker, vektøy og teknologi danner tilsammen det som kalles et \textit{$"$sosioteknisk system$"$} \citep{Coiera04}.
